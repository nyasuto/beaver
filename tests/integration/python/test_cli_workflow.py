...
from utils import BeaverRunner
...
class TestCLIWorkflow:
    ...
    def test_beaver_version_command(self, beaver_binary):
        ...
        assert "バージョン" in stdout or "version" in stdout.lower(), (
            f"Version info missing: {stdout}"
        )
    ...
    def test_build_command_basic(
        ...
        cleanup_test_files.extend(["_site", "*.md", ".beaver"])
