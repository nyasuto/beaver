...
│   ├── models/        # データモデル
│   └── logger/        # 構造化ログ
├── templates/          # Wiki生成テンプレート
├── assets/            # 静的アセット（CSS/JS）
└── scripts/           # CI/CD自動化スクリプト
```

**技術スタック:**
- **メイン言語**: Go 1.24（CLI、API統合、Wiki生成）
...
# Wiki生成 (実装済み)
beaver wiki generate <repository>             # Multi-format Wiki生成
...
- ✅ **Wiki生成エンジン**: Go template + goldmark、マルチフォーマット出力
...
- **Wiki生成**: goldmark、Go template、マルチフォーマット出力
