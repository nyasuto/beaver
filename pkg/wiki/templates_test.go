...
func TestListTemplates(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			setupTemplates: nil,
			expectedNames:  []string{"issues-summary", "troubleshooting", "learning-path", "index", "processing-logs", "statistics", "label-analysis", "quick-reference", "development-strategy", "_sidebar", "developer-dashboard"},
		...
		},
		{
			...
			expectedNames: []string{"issues-summary", "troubleshooting", "learning-path", "index", "processing-logs", "statistics", "label-analysis", "quick-reference", "development-strategy", "_sidebar", "developer-dashboard", "custom1", "custom2"},
...
func TestTemplateManagerIntegration(t *testing.T) {
	...
	templates := tm.ListTemplates()
	assert.Len(t, templates, 11, "Should have 11 working default templates including _sidebar and developer-dashboard")

	// Test that each default template can be retrieved
	for _, name := range []string{"issues-summary", "troubleshooting", "learning-path", "index", "processing-logs", "statistics", "label-analysis", "quick-reference", "development-strategy", "_sidebar", "developer-dashboard"} {
	...
	assert.Len(t, updatedTemplates, 12, "Should have 12 templates after adding custom to 11 defaults")
