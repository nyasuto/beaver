...
class ClassificationService:
    ...
    def __init__(self, settings: Settings):
        ...
        self.categories = {
            ...
            "architecture": {
                ...
                "keywords": ["design", "architecture", "refactor", "structure", "performance", "test", "coverage"]
            },
            "learning": {
                "name": "学習・調査",
                "description": "技術調査・研究、学習用Issue、実験、プロトタイプ開発に関するIssue",
                "keywords": ["research", "investigate", "study", "learn", "experiment", "prototype"]
            },
            "troubleshooting": {
                "name": "トラブルシューティング", 
    ...
    def _create_classification_prompt(self, issue: Issue, config: Optional[ClassificationConfig] = None) -> List[BaseMessage]:
...
リポジトリ: {issue.repository or 'N/A'}"""
    ...
    def _parse_classification_response(self, response_text: str, issue_id: int) -> ClassificationResult:
        ...
        try:
            ...
            if category not in self.categories:
                logger.warning(f"Invalid category '{category}' for issue {issue_id}, using 'troubleshooting'")
