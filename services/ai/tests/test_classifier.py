...
class TestClassificationService:
    ...
    async def test_batch_classify_parallel(self, classification_service):
        ...
        mock_results = [
            ClassificationResult(issue_id=1, category="bug-fix", confidence=0.9, reasoning="Bug", suggested_tags=[]),
            ClassificationResult(issue_id=2, category="feature-request", confidence=0.8, reasoning="Feature", suggested_tags=[])
        ]
