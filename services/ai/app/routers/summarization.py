...
async def _real_summarization(
    request: SummarizationRequest, settings: Settings
) -> SummarizationResponse:
    """
...
async def _fallback_summarization(
    request: SummarizationRequest, settings: Settings, error: str
) -> SummarizationResponse:
    """
...
async def summarize_issues_batch(
    ...
    for issue_data in request.issues:
        try:
            ...
            failed_issues.append({"issue_number": issue_data.number, "error": str(e)})
