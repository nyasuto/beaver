...
describe('GitHubClient', () => {
  ...
  // Note: isAuthenticated is not implemented in GitHubClient
  // The client assumes a valid token is provided during construction

  // Note: updateConfig is not implemented in GitHubClient
