    ...
    return {
      ...
      recentActivity: {
        ...
        recentlyUpdated: [
          {
            id: 88,
            title: 'feat: ホームページのヘッダーナビゲーション統一を修正',
            number: 88,
          ...
          {
            id: 87,
            title: 'feat: Issue #75 デザインシステム統一の実装',
            number: 87,
          ...
          {
            id: 86,
            title: 'feat: AnalyticsページレイアウトをPageLayoutに統一',
            number: 86,
          ...
          },
          {
            ...
            number: 85,
            updated_at: new Date(now.getTime() - 18 * 60 * 60 * 1000).toISOString(),
            state: 'open' as const,
          },
        ],
      },
      labels: [
        { name: 'feat', color: '00ff00', count: 25 },
        { name: 'fix', color: 'ff0000', count: 18 },
        { name: 'enhancement', color: '0000ff', count: 12 },
        { name: 'bug', color: 'dc143c', count: 8 },
        { name: 'documentation', color: '006b75', count: 6 },
        { name: 'priority: high', color: 'ff8c00', count: 5 },
        { name: 'good first issue', color: '7057ff', count: 4 },
        { name: 'priority: critical', color: 'b60205', count: 2 },
      ],
      meta: {
        source: 'fallback',
        generated_at: now.toISOString(),
